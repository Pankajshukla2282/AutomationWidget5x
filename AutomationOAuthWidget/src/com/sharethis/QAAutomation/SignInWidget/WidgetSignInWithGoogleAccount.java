...
public class WidgetSignInWithGoogleAccount {
	StringBuffer red = new StringBuffer("1");

	@Parameters( { "STLBDataID", "STLBExpVal", "STLDataID", "STLExpVal", "STBCDataID"})
	@Test
	public void test_WidgetSignInWithGoogleAccount(int STLBDataID,
		...
		/***********************************************************************
		 * ST_SIW_06- This scenario is to Signing-in into widget with valid Google credentials
		1. Browse to any website. 
		2. Click on sharethis widget to launch widget.
		3. Click on Sign in link, login window appears.
		4. Click on Google icon
		 **********************************************************************/		
		...
		status = login.stGoogleLogin(STLDataID, STLExpVal, "");
		
		comLib.stLogResult(status, "ST_SIW_06", "STOP", red);		
