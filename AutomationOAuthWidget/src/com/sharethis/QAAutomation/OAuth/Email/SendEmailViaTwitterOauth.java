...
public class SendEmailViaTwitterOauth {
	StringBuffer red = new StringBuffer("1");
	
	@Parameters( { "STLBDataID", "STLBExpVal", "STLDataID", "STLExpVal", "STBCDataID", "STEDataID"})
	@Test
public  void test_SendEmailViaTwitterOauth(int STLBDataID, int STLBExpVal, int STLDataID, 
		...
		//*******Click on Twitter Oauth service*********
		comLib.stClickAndVerifyLink(EMAIL_TWITTER_OAUTH, STBCDataID, 0, 1, "STOP");
		
		//*******Login With Twitter Account**********
		login.stTwitterLoginEmailScreen(STLDataID, STLExpVal, "STOP");		
		...
		comLib.stLogResult(status, "ST_ESM_26", "", red);		
